...
import { z } from "zod";
import type { AutocompleteFieldProps } from "./AutocompleteField";

// ─── Types ───

export type RadioGroupFieldVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
...
export const RadioGroupField = forwardRef<HTMLDivElement, RadioGroupFieldProps>(function RadioGroupField(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "RadioGroupField"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Radio Group Field</h3>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-3">
          {(props as RadioGroupFieldProps).label && (
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {(props as RadioGroupFieldProps).label}
              {(props as RadioGroupFieldProps).required && <span className="text-red-500 ml-1">*</span>}
            </label>
          )}
          <div className="relative">
            <input
              type="text"
              name={(props as RadioGroupFieldProps).name}
              placeholder={(props as RadioGroupFieldProps).placeholder}
              disabled={disabled}
              autoFocus={(props as RadioGroupFieldProps).autoFocus}
          ...
          {(props as RadioGroupFieldProps).description && (
            <p className="text-xs text-gray-500">{(props as RadioGroupFieldProps).description}</p>
          )}
          {(props as RadioGroupFieldProps).error && (
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>forms/RadioGroupField</span>
