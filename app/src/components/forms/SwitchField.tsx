...
export type SwitchFieldVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type SwitchFieldSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const SwitchField = forwardRef<HTMLDivElement, SwitchFieldProps>(function SwitchField(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SwitchField"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Switch Field</h3>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-3">
          {(props as SwitchFieldProps).label && (
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {(props as SwitchFieldProps).label}
              {(props as SwitchFieldProps).required && <span className="text-red-500 ml-1">*</span>}
            </label>
          )}
          <div className="relative">
            <input
              type="text"
              name={(props as SwitchFieldProps).name}
              placeholder={(props as SwitchFieldProps).placeholder}
              disabled={disabled}
              autoFocus={(props as SwitchFieldProps).autoFocus}
          ...
          {(props as SwitchFieldProps).description && (
            <p className="text-xs text-gray-500">{(props as SwitchFieldProps).description}</p>
          )}
          {(props as SwitchFieldProps).error && (
