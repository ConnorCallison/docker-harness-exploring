...
export type CustomFieldFormVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type CustomFieldFormSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface CustomFieldFormProps {
  className?: string;
  children?: React.ReactNode;
  variant?: CustomFieldFormVariant;
  size?: CustomFieldFormSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const CustomFieldForm = forwardRef<HTMLDivElement, CustomFieldFormProps>(function CustomFieldForm(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "CustomFieldForm"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Custom Field Form</h3>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-3">
          {(props as CustomFieldFormProps).label && (
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {(props as CustomFieldFormProps).label}
              {(props as CustomFieldFormProps).required && <span className="text-red-500 ml-1">*</span>}
            </label>
          )}
          <div className="relative">
            <input
              type="text"
              name={(props as CustomFieldFormProps).name}
              placeholder={(props as CustomFieldFormProps).placeholder}
              disabled={disabled}
              autoFocus={(props as CustomFieldFormProps).autoFocus}
          ...
          {(props as CustomFieldFormProps).description && (
            <p className="text-xs text-gray-500">{(props as CustomFieldFormProps).description}</p>
          )}
          {(props as CustomFieldFormProps).error && (
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>forms/CustomFieldForm</span>
