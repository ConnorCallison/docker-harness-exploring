...
export type SortConfigFormVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type SortConfigFormSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SortConfigFormProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SortConfigFormVariant;
  size?: SortConfigFormSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const SortConfigForm = forwardRef<HTMLDivElement, SortConfigFormProps>(function SortConfigForm(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SortConfigForm"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Sort Config Form</h3>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-3">
          {(props as SortConfigFormProps).label && (
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {(props as SortConfigFormProps).label}
              {(props as SortConfigFormProps).required && <span className="text-red-500 ml-1">*</span>}
            </label>
          )}
          <div className="relative">
            <input
              type="text"
              name={(props as SortConfigFormProps).name}
              placeholder={(props as SortConfigFormProps).placeholder}
              disabled={disabled}
              autoFocus={(props as SortConfigFormProps).autoFocus}
          ...
          {(props as SortConfigFormProps).description && (
            <p className="text-xs text-gray-500">{(props as SortConfigFormProps).description}</p>
          )}
          {(props as SortConfigFormProps).error && (
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>forms/SortConfigForm</span>
