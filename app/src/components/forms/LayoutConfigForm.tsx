...
export type LayoutConfigFormVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type LayoutConfigFormSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface LayoutConfigFormProps {
  className?: string;
  children?: React.ReactNode;
  variant?: LayoutConfigFormVariant;
  size?: LayoutConfigFormSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const LayoutConfigForm = forwardRef<HTMLDivElement, LayoutConfigFormProps>(function LayoutConfigForm(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "LayoutConfigForm"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Layout Config Form</h3>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-3">
          {(props as LayoutConfigFormProps).label && (
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {(props as LayoutConfigFormProps).label}
              {(props as LayoutConfigFormProps).required && <span className="text-red-500 ml-1">*</span>}
            </label>
          )}
          <div className="relative">
            <input
              type="text"
              name={(props as LayoutConfigFormProps).name}
              placeholder={(props as LayoutConfigFormProps).placeholder}
              disabled={disabled}
              autoFocus={(props as LayoutConfigFormProps).autoFocus}
          ...
          {(props as LayoutConfigFormProps).description && (
            <p className="text-xs text-gray-500">{(props as LayoutConfigFormProps).description}</p>
          )}
          {(props as LayoutConfigFormProps).error && (
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>forms/LayoutConfigForm</span>
