...
export type TextareaFieldVariant = "default" | "primary" | "secondary";
...
export const TextareaField = forwardRef<HTMLDivElement, TextareaFieldProps>(function TextareaField(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "TextareaField"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Textarea Field</h3>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-3">
          {(props as TextareaFieldProps).label && (
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {(props as TextareaFieldProps).label}
              {(props as TextareaFieldProps).required && <span className="text-red-500 ml-1">*</span>}
            </label>
          )}
          <div className="relative">
            <input
              ...
              disabled={disabled}
              autoFocus={(props as TextareaFieldProps).autoFocus}
          ...
          {(props as TextareaFieldProps).description && (
            <p className="text-xs text-gray-500">{(props as TextareaFieldProps).description}</p>
          )}
          {(props as TextareaFieldProps).error && (
