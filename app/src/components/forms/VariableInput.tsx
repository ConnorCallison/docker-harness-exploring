...
export type VariableInputVariant = "default" | "primary" | "secondary" | "destructive";
export type VariableInputSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const VariableInput = forwardRef<HTMLDivElement, VariableInputProps>(function VariableInput(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "VariableInput"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Variable Input</h3>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-3">
          {(props as VariableInputProps).label && (
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {(props as VariableInputProps).label}
              {(props as VariableInputProps).required && <span className="text-red-500 ml-1">*</span>}
            </label>
          )}
          <div className="relative">
            <input
              type="text"
              name={(props as VariableInputProps).name}
              placeholder={(props as VariableInputProps).placeholder}
              disabled={disabled}
              autoFocus={(props as VariableInputProps).autoFocus}
          ...
          {(props as VariableInputProps).description && (
            <p className="text-xs text-gray-500">{(props as VariableInputProps).description}</p>
          )}
          {(props as VariableInputProps).error && (
