...
export type QuickActionsVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type QuickActionsSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const QuickActions = forwardRef<HTMLDivElement, QuickActionsProps>(function QuickActions(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "QuickActions"}
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/QuickActions</span>
