...
export type KeyboardShortcutsVariant = "default" | "primary" | "secondary" | "destructive";
export type KeyboardShortcutsSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface KeyboardShortcutsProps {
  className?: string;
  children?: React.ReactNode;
  variant?: KeyboardShortcutsVariant;
  size?: KeyboardShortcutsSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const KeyboardShortcuts = forwardRef<HTMLDivElement, KeyboardShortcutsProps>(function KeyboardShortcuts(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "KeyboardShortcuts"}
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/KeyboardShortcuts</span>
