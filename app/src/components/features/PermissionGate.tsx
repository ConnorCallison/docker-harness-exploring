...
import type { QuickActionsProps } from "./QuickActions";
import type { KeyboardShortcutsProps } from "./KeyboardShortcuts";

// ─── Types ───

export type PermissionGateVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type PermissionGateSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface PermissionGateProps {
  className?: string;
  children?: React.ReactNode;
  variant?: PermissionGateVariant;
  size?: PermissionGateSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const PermissionGate = forwardRef<HTMLDivElement, PermissionGateProps>(function PermissionGate(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "PermissionGate"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
            <span className="text-white font-semibold text-sm">PE</span>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Permission Gate</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/PermissionGate</span>
