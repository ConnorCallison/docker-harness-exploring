...
export type ClipboardManagerVariant = "default" | "primary" | "secondary" | "destructive";
export type ClipboardManagerSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ClipboardManagerProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ClipboardManagerVariant;
  size?: ClipboardManagerSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const ClipboardManager = forwardRef<HTMLDivElement, ClipboardManagerProps>(function ClipboardManager(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ClipboardManager"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Clipboard Manager</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/ClipboardManager</span>
