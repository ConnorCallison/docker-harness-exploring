...
export type GlobalSearchVariant = "default" | "primary" | "secondary";
export type GlobalSearchSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const GlobalSearch = forwardRef<HTMLDivElement, GlobalSearchProps>(function GlobalSearch(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "GlobalSearch"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
            <span className="text-white font-semibold text-sm">GL</span>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Global Search</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/GlobalSearch</span>
