...
export type CommentThreadVariant = "default" | "primary" | "secondary";
export type CommentThreadSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const CommentThread = forwardRef<HTMLDivElement, CommentThreadProps>(function CommentThread(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "CommentThread"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Comment Thread</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/CommentThread</span>
