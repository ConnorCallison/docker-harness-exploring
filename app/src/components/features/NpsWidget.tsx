...
export type NpsWidgetVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type NpsWidgetSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface NpsWidgetProps {
  className?: string;
  children?: React.ReactNode;
  variant?: NpsWidgetVariant;
  size?: NpsWidgetSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
...
export const NpsWidget = forwardRef<HTMLDivElement, NpsWidgetProps>(function NpsWidget(
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Nps Widget</h3>
