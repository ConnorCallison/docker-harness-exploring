...
export type WizardDialogVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type WizardDialogSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface WizardDialogProps {
  className?: string;
  children?: React.ReactNode;
  variant?: WizardDialogVariant;
...
export const WizardDialog = forwardRef<HTMLDivElement, WizardDialogProps>(function WizardDialog(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "WizardDialog"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
            <span className="text-white font-semibold text-sm">WI</span>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Wizard Dialog</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/WizardDialog</span>
