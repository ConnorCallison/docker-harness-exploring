...
import type { FeedbackWidgetProps } from "./FeedbackWidget";
import type { SatisfactionSurveyProps } from "./SatisfactionSurvey";

// ─── Types ───

export type ActivityFeedVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type ActivityFeedSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const ActivityFeed = forwardRef<HTMLDivElement, ActivityFeedProps>(function ActivityFeed(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ActivityFeed"}
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/ActivityFeed</span>
