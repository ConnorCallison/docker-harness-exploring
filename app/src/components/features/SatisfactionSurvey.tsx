...
export type SatisfactionSurveyVariant = "default" | "primary" | "secondary" | "destructive";
export type SatisfactionSurveySize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SatisfactionSurveyProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SatisfactionSurveyVariant;
  size?: SatisfactionSurveySize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const SatisfactionSurvey = forwardRef<HTMLDivElement, SatisfactionSurveyProps>(function SatisfactionSurvey(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SatisfactionSurvey"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Satisfaction Survey</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/SatisfactionSurvey</span>
