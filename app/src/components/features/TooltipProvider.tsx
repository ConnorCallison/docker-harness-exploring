...
import type { SpeechToTextProps } from "./SpeechToText";
import type { UserMenuProps } from "./UserMenu";

// ─── Types ───

export type TooltipProviderVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type TooltipProviderSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface TooltipProviderProps {
  className?: string;
  children?: React.ReactNode;
  variant?: TooltipProviderVariant;
  size?: TooltipProviderSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const TooltipProvider = forwardRef<HTMLDivElement, TooltipProviderProps>(function TooltipProvider(
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Tooltip Provider</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/TooltipProvider</span>
