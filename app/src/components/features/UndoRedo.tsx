...
export type UndoRedoVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type UndoRedoSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface UndoRedoProps {
  className?: string;
  children?: React.ReactNode;
  variant?: UndoRedoVariant;
  size?: UndoRedoSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
...
export const UndoRedo = forwardRef<HTMLDivElement, UndoRedoProps>(function UndoRedo(
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Undo Redo</h3>
