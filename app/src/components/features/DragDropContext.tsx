...
export type DragDropContextVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type DragDropContextSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface DragDropContextProps {
  className?: string;
  children?: React.ReactNode;
  variant?: DragDropContextVariant;
  size?: DragDropContextSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const DragDropContext = forwardRef<HTMLDivElement, DragDropContextProps>(function DragDropContext(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "DragDropContext"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Drag Drop Context</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/DragDropContext</span>
