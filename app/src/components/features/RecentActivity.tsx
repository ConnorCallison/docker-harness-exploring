...
export type RecentActivityVariant = "default" | "primary" | "secondary" | "destructive";
export type RecentActivitySize = "xs" | "sm" | "md" | "lg" | "xl";

export interface RecentActivityProps {
  className?: string;
  children?: React.ReactNode;
  variant?: RecentActivityVariant;
  size?: RecentActivitySize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const RecentActivity = forwardRef<HTMLDivElement, RecentActivityProps>(function RecentActivity(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "RecentActivity"}
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/RecentActivity</span>
