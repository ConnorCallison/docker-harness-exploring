...
export type ImportDialogVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type ImportDialogSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ImportDialogProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ImportDialogVariant;
...
export const ImportDialog = forwardRef<HTMLDivElement, ImportDialogProps>(function ImportDialog(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ImportDialog"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Import Dialog</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>features/ImportDialog</span>
