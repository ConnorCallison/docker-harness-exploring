...
export type VirtualGridVariant = "default" | "primary" | "secondary";
export type VirtualGridSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface VirtualGridProps {
  className?: string;
  children?: React.ReactNode;
  variant?: VirtualGridVariant;
  size?: VirtualGridSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const VirtualGrid = forwardRef<HTMLDivElement, VirtualGridProps>(function VirtualGrid(
  ...
  const processedData = useMemo(() => {
    const raw = (props as VirtualGridProps).data ?? [];
  ...
  }, [(props as VirtualGridProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "VirtualGrid"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Virtual Grid</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as VirtualGridProps).columns ?? []).map((col) => (
