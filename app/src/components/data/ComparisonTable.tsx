...
export type ComparisonTableVariant = "default" | "primary" | "secondary" | "destructive";
export type ComparisonTableSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const ComparisonTable = forwardRef<HTMLDivElement, ComparisonTableProps>(function ComparisonTable(
  ...
  const processedData = useMemo(() => {
    const raw = (props as ComparisonTableProps).data ?? [];
  ...
  }, [(props as ComparisonTableProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ComparisonTable"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Comparison Table</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as ComparisonTableProps).columns ?? []).map((col) => (
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>data/ComparisonTable</span>
