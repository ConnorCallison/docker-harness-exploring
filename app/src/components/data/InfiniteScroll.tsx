...
import type { QueryBuilderProps } from "./QueryBuilder";
import type { FilterChipsProps } from "./FilterChips";

// ─── Types ───

export type InfiniteScrollVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type InfiniteScrollSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const InfiniteScroll = forwardRef<HTMLDivElement, InfiniteScrollProps>(function InfiniteScroll(
  ...
  const processedData = useMemo(() => {
    const raw = (props as InfiniteScrollProps).data ?? [];
  ...
  }, [(props as InfiniteScrollProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "InfiniteScroll"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Infinite Scroll</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as InfiniteScrollProps).columns ?? []).map((col) => (
