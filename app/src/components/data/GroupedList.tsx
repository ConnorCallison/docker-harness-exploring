...
export type GroupedListVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type GroupedListSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const GroupedList = forwardRef<HTMLDivElement, GroupedListProps>(function GroupedList(
  ...
  const processedData = useMemo(() => {
    const raw = (props as GroupedListProps).data ?? [];
  ...
  }, [(props as GroupedListProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "GroupedList"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Grouped List</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as GroupedListProps).columns ?? []).map((col) => (
