...
export type VirtualListVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type VirtualListSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const VirtualList = forwardRef<HTMLDivElement, VirtualListProps>(function VirtualList(
  ...
  const processedData = useMemo(() => {
    const raw = (props as VirtualListProps).data ?? [];
  ...
  }, [(props as VirtualListProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "VirtualList"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Virtual List</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as VirtualListProps).columns ?? []).map((col) => (
