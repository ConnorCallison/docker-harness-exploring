...
import type { StatDisplayProps } from "./StatDisplay";
import type { ComparisonTableProps } from "./ComparisonTable";
import type { PivotTableProps } from "./PivotTable";

// ─── Types ───

export type EmptyStateVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
...
export const EmptyState = forwardRef<HTMLDivElement, EmptyStateProps>(function EmptyState(
  ...
  const processedData = useMemo(() => {
    const raw = (props as EmptyStateProps).data ?? [];
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Empty State</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as EmptyStateProps).columns ?? []).map((col) => (
