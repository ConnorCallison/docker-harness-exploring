...
export type DataExplorerVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type DataExplorerSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface DataExplorerProps {
  className?: string;
  children?: React.ReactNode;
  variant?: DataExplorerVariant;
  size?: DataExplorerSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const DataExplorer = forwardRef<HTMLDivElement, DataExplorerProps>(function DataExplorer(
  ...
  const processedData = useMemo(() => {
    const raw = (props as DataExplorerProps).data ?? [];
  ...
  }, [(props as DataExplorerProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "DataExplorer"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Data Explorer</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as DataExplorerProps).columns ?? []).map((col) => (
