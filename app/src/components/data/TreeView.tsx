...
export type TreeViewVariant = "default" | "primary" | "secondary" | "destructive";
...
export const TreeView = forwardRef<HTMLDivElement, TreeViewProps>(function TreeView(
  ...
  const processedData = useMemo(() => {
    const raw = (props as TreeViewProps).data ?? [];
  ...
  }, [(props as TreeViewProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "TreeView"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Tree View</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as TreeViewProps).columns ?? []).map((col) => (
