...
import type { FrozenColumnsProps } from "./FrozenColumns";
import type { DataTableProps } from "./DataTable";

// ─── Types ───

export type TableSkeletonVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type TableSkeletonSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const TableSkeleton = forwardRef<HTMLDivElement, TableSkeletonProps>(function TableSkeleton(
  ...
  const processedData = useMemo(() => {
    const raw = (props as TableSkeletonProps).data ?? [];
  ...
  }, [(props as TableSkeletonProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "TableSkeleton"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Table Skeleton</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as TableSkeletonProps).columns ?? []).map((col) => (
