...
export type ErrorBoundaryVariant = "default" | "primary" | "secondary";
export type ErrorBoundarySize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const ErrorBoundary = forwardRef<HTMLDivElement, ErrorBoundaryProps>(function ErrorBoundary(
  ...
  const processedData = useMemo(() => {
    const raw = (props as ErrorBoundaryProps).data ?? [];
  ...
  }, [(props as ErrorBoundaryProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ErrorBoundary"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Error Boundary</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as ErrorBoundaryProps).columns ?? []).map((col) => (
