...
export type SortableTableVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type SortableTableSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SortableTableProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SortableTableVariant;
  size?: SortableTableSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const SortableTable = forwardRef<HTMLDivElement, SortableTableProps>(function SortableTable(
  ...
  const processedData = useMemo(() => {
    const raw = (props as SortableTableProps).data ?? [];
  ...
  }, [(props as SortableTableProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SortableTable"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Sortable Table</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as SortableTableProps).columns ?? []).map((col) => (
