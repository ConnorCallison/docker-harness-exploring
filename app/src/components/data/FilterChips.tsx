...
export type FilterChipsVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type FilterChipsSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const FilterChips = forwardRef<HTMLDivElement, FilterChipsProps>(function FilterChips(
  ...
  const processedData = useMemo(() => {
    const raw = (props as FilterChipsProps).data ?? [];
  ...
  }, [(props as FilterChipsProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "FilterChips"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Filter Chips</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as FilterChipsProps).columns ?? []).map((col) => (
