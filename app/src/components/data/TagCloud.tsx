...
export type TagCloudVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type TagCloudSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const TagCloud = forwardRef<HTMLDivElement, TagCloudProps>(function TagCloud(
  ...
  const processedData = useMemo(() => {
    const raw = (props as TagCloudProps).data ?? [];
  ...
  }, [(props as TagCloudProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "TagCloud"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Tag Cloud</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as TagCloudProps).columns ?? []).map((col) => (
