...
export type ExpandableRowVariant = "default" | "primary" | "secondary" | "destructive";
export type ExpandableRowSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ExpandableRowProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ExpandableRowVariant;
  size?: ExpandableRowSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const ExpandableRow = forwardRef<HTMLDivElement, ExpandableRowProps>(function ExpandableRow(
  ...
  const processedData = useMemo(() => {
    const raw = (props as ExpandableRowProps).data ?? [];
  ...
  }, [(props as ExpandableRowProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ExpandableRow"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Expandable Row</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as ExpandableRowProps).columns ?? []).map((col) => (
