...
export type FilterBarVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type FilterBarSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const FilterBar = forwardRef<HTMLDivElement, FilterBarProps>(function FilterBar(
  ...
  const processedData = useMemo(() => {
    const raw = (props as FilterBarProps).data ?? [];
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Filter Bar</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as FilterBarProps).columns ?? []).map((col) => (
