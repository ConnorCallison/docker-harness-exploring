...
export type DataCardVariant = "default" | "primary" | "secondary" | "destructive";
export type DataCardSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const DataCard = forwardRef<HTMLDivElement, DataCardProps>(function DataCard(
  ...
  const processedData = useMemo(() => {
    const raw = (props as DataCardProps).data ?? [];
  ...
  }, [(props as DataCardProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "DataCard"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Data Card</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as DataCardProps).columns ?? []).map((col) => (
