...
import type { NestedTableProps } from "./NestedTable";
import type { ExpandableRowProps } from "./ExpandableRow";

// ─── Types ───

export type CardGridVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type CardGridSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const CardGrid = forwardRef<HTMLDivElement, CardGridProps>(function CardGrid(
  ...
  const processedData = useMemo(() => {
    const raw = (props as CardGridProps).data ?? [];
  ...
  }, [(props as CardGridProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "CardGrid"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Card Grid</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as CardGridProps).columns ?? []).map((col) => (
