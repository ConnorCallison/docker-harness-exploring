...
export type ActiveFiltersVariant = "default" | "primary" | "secondary";
export type ActiveFiltersSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ActiveFiltersProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ActiveFiltersVariant;
  size?: ActiveFiltersSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const ActiveFilters = forwardRef<HTMLDivElement, ActiveFiltersProps>(function ActiveFilters(
  ...
  const processedData = useMemo(() => {
    const raw = (props as ActiveFiltersProps).data ?? [];
  ...
  }, [(props as ActiveFiltersProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ActiveFilters"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Active Filters</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as ActiveFiltersProps).columns ?? []).map((col) => (
