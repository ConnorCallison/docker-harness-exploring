...
export type PaginationControlsVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type PaginationControlsSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const PaginationControls = forwardRef<HTMLDivElement, PaginationControlsProps>(function PaginationControls(
  ...
  const processedData = useMemo(() => {
    const raw = (props as PaginationControlsProps).data ?? [];
  ...
  }, [(props as PaginationControlsProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "PaginationControls"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Pagination Controls</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as PaginationControlsProps).columns ?? []).map((col) => (
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>data/PaginationControls</span>
