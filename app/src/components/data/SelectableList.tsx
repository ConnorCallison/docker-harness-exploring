...
export type SelectableListVariant = "default" | "primary" | "secondary";
export type SelectableListSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SelectableListProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SelectableListVariant;
  size?: SelectableListSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const SelectableList = forwardRef<HTMLDivElement, SelectableListProps>(function SelectableList(
  ...
  const processedData = useMemo(() => {
    const raw = (props as SelectableListProps).data ?? [];
  ...
  }, [(props as SelectableListProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SelectableList"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Selectable List</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as SelectableListProps).columns ?? []).map((col) => (
