...
export type DataGridVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type DataGridSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const DataGrid = forwardRef<HTMLDivElement, DataGridProps>(function DataGrid(
  ...
  const processedData = useMemo(() => {
    const raw = (props as DataGridProps).data ?? [];
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Data Grid</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as DataGridProps).columns ?? []).map((col) => (
