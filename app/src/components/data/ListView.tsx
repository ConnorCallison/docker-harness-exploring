...
import type { MasonryGridProps } from "./MasonryGrid";

// ─── Types ───

export type ListViewVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type ListViewSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const ListView = forwardRef<HTMLDivElement, ListViewProps>(function ListView(
  ...
  const processedData = useMemo(() => {
    const raw = (props as ListViewProps).data ?? [];
  ...
  }, [(props as ListViewProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ListView"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">List View</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as ListViewProps).columns ?? []).map((col) => (
