...
export type ColumnSelectorVariant = "default" | "primary" | "secondary" | "destructive";
export type ColumnSelectorSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ColumnSelectorProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ColumnSelectorVariant;
  size?: ColumnSelectorSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const ColumnSelector = forwardRef<HTMLDivElement, ColumnSelectorProps>(function ColumnSelector(
  ...
  const processedData = useMemo(() => {
    const raw = (props as ColumnSelectorProps).data ?? [];
  ...
  }, [(props as ColumnSelectorProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ColumnSelector"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Column Selector</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as ColumnSelectorProps).columns ?? []).map((col) => (
