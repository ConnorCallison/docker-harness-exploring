...
export type StatDisplayVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type StatDisplaySize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const StatDisplay = forwardRef<HTMLDivElement, StatDisplayProps>(function StatDisplay(
  ...
  const processedData = useMemo(() => {
    const raw = (props as StatDisplayProps).data ?? [];
  ...
  }, [(props as StatDisplayProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "StatDisplay"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Stat Display</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as StatDisplayProps).columns ?? []).map((col) => (
