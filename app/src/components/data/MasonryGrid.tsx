...
export type MasonryGridVariant = "default" | "primary" | "secondary" | "destructive";
export type MasonryGridSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface MasonryGridProps {
  className?: string;
  children?: React.ReactNode;
  variant?: MasonryGridVariant;
  size?: MasonryGridSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const MasonryGrid = forwardRef<HTMLDivElement, MasonryGridProps>(function MasonryGrid(
  ...
  const processedData = useMemo(() => {
    const raw = (props as MasonryGridProps).data ?? [];
  ...
  }, [(props as MasonryGridProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "MasonryGrid"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Masonry Grid</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as MasonryGridProps).columns ?? []).map((col) => (
