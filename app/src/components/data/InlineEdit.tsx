...
export type InlineEditVariant = "default" | "primary" | "secondary";
export type InlineEditSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const InlineEdit = forwardRef<HTMLDivElement, InlineEditProps>(function InlineEdit(
  ...
  const processedData = useMemo(() => {
    const raw = (props as InlineEditProps).data ?? [];
  ...
  }, [(props as InlineEditProps).data]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "InlineEdit"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Inline Edit</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                {((props as InlineEditProps).columns ?? []).map((col) => (
