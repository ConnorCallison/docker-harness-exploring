...
export type ScatterChartVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type ScatterChartSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const ScatterChart = forwardRef<HTMLDivElement, ScatterChartProps>(function ScatterChart(
  ...
  const chartData = useMemo(() => {
    const raw = (props as ScatterChartProps).data ?? [];
    return raw.map((d, i) => ({
      ...d,
      _color: d.category ? `hsl(${(i * 360) / raw.length}, 70%, 50%)` : (props as ScatterChartProps).color ?? "#3b82f6",
    }));
  }, [(props as ScatterChartProps).data, (props as ScatterChartProps).color]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ScatterChart"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Scatter Chart</h3>
      ...
      <div className="p-4 space-y-4">
        <div style={{ height: (props as ScatterChartProps).height ?? 300 }}>
