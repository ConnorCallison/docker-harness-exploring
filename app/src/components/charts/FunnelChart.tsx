...
export type FunnelChartVariant = "default" | "primary" | "secondary";
export type FunnelChartSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const FunnelChart = forwardRef<HTMLDivElement, FunnelChartProps>(function FunnelChart(
  ...
  const chartData = useMemo(() => {
    const raw = (props as FunnelChartProps).data ?? [];
    return raw.map((d, i) => ({
      ...d,
      _color: d.category ? `hsl(${(i * 360) / raw.length}, 70%, 50%)` : (props as FunnelChartProps).color ?? "#3b82f6",
    }));
  }, [(props as FunnelChartProps).data, (props as FunnelChartProps).color]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "FunnelChart"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Funnel Chart</h3>
      ...
      <div className="p-4 space-y-4">
        <div style={{ height: (props as FunnelChartProps).height ?? 300 }}>
