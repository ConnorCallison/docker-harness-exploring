...
export type HistogramVariant = "default" | "primary" | "secondary" | "destructive";
export type HistogramSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const Histogram = forwardRef<HTMLDivElement, HistogramProps>(function Histogram(
  ...
  const chartData = useMemo(() => {
    const raw = (props as HistogramProps).data ?? [];
    return raw.map((d, i) => ({
      ...d,
      _color: d.category ? `hsl(${(i * 360) / raw.length}, 70%, 50%)` : (props as HistogramProps).color ?? "#3b82f6",
    }));
  }, [(props as HistogramProps).data, (props as HistogramProps).color]);
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Histogram</h3>
      ...
      <div className="p-4 space-y-4">
        <div style={{ height: (props as HistogramProps).height ?? 300 }}>
