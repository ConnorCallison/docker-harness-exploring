...
export type SparklineVariant = "default" | "primary" | "secondary";
...
export const Sparkline = forwardRef<HTMLDivElement, SparklineProps>(function Sparkline(
  ...
  const chartData = useMemo(() => {
    const raw = (props as SparklineProps).data ?? [];
    return raw.map((d, i) => ({
      ...d,
      _color: d.category ? `hsl(${(i * 360) / raw.length}, 70%, 50%)` : (props as SparklineProps).color ?? "#3b82f6",
    }));
  }, [(props as SparklineProps).data, (props as SparklineProps).color]);
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Sparkline</h3>
      ...
      <div className="p-4 space-y-4">
        <div style={{ height: (props as SparklineProps).height ?? 300 }}>
