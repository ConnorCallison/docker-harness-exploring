...
export type BarChartVariant = "default" | "primary" | "secondary";
...
export const BarChart = forwardRef<HTMLDivElement, BarChartProps>(function BarChart(
  ...
  const chartData = useMemo(() => {
    const raw = (props as BarChartProps).data ?? [];
    return raw.map((d, i) => ({
      ...d,
      _color: d.category ? `hsl(${(i * 360) / raw.length}, 70%, 50%)` : (props as BarChartProps).color ?? "#3b82f6",
    }));
  }, [(props as BarChartProps).data, (props as BarChartProps).color]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "BarChart"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Bar Chart</h3>
      ...
      <div className="p-4 space-y-4">
        <div style={{ height: (props as BarChartProps).height ?? 300 }}>
