...
export type AreaChartVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type AreaChartSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const AreaChart = forwardRef<HTMLDivElement, AreaChartProps>(function AreaChart(
  ...
  const chartData = useMemo(() => {
    const raw = (props as AreaChartProps).data ?? [];
    return raw.map((d, i) => ({
      ...d,
      _color: d.category ? `hsl(${(i * 360) / raw.length}, 70%, 50%)` : (props as AreaChartProps).color ?? "#3b82f6",
    }));
  }, [(props as AreaChartProps).data, (props as AreaChartProps).color]);

  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "AreaChart"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Area Chart</h3>
      ...
      <div className="p-4 space-y-4">
        <div style={{ height: (props as AreaChartProps).height ?? 300 }}>
