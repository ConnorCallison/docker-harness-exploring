...
export type MasterDetailVariant = "default" | "primary" | "secondary";
export type MasterDetailSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface MasterDetailProps {
  className?: string;
  children?: React.ReactNode;
  variant?: MasterDetailVariant;
  size?: MasterDetailSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const MasterDetail = forwardRef<HTMLDivElement, MasterDetailProps>(function MasterDetail(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "MasterDetail"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Master Detail</h3>
