...
export type SimpleGridVariant = "default" | "primary" | "secondary" | "destructive";
export type SimpleGridSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SimpleGridProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SimpleGridVariant;
  size?: SimpleGridSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Simple Grid</h3>
