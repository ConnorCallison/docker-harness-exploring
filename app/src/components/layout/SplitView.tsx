...
export type SplitViewVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type SplitViewSize = "xs" | "sm" | "md" | "lg" | "xl";
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Split View</h3>
