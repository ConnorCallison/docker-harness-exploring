...
export type StickyHeaderVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type StickyHeaderSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface StickyHeaderProps {
  className?: string;
  children?: React.ReactNode;
  variant?: StickyHeaderVariant;
  size?: StickyHeaderSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const StickyHeader = forwardRef<HTMLDivElement, StickyHeaderProps>(function StickyHeader(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "StickyHeader"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Sticky Header</h3>
