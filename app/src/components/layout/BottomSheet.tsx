...
import type { StickyHeaderProps } from "./StickyHeader";
import type { FloatingNavProps } from "./FloatingNav";

// ─── Types ───

export type BottomSheetVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type BottomSheetSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const BottomSheet = forwardRef<HTMLDivElement, BottomSheetProps>(function BottomSheet(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "BottomSheet"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Bottom Sheet</h3>
