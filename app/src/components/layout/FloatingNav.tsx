...
export type FloatingNavVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type FloatingNavSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const FloatingNav = forwardRef<HTMLDivElement, FloatingNavProps>(function FloatingNav(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "FloatingNav"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Floating Nav</h3>
