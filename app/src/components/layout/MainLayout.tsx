...
export type MainLayoutVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type MainLayoutSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const MainLayout = forwardRef<HTMLDivElement, MainLayoutProps>(function MainLayout(
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Main Layout</h3>
