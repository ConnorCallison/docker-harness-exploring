...
export type SystemHealthIndicatorVariant = "default" | "primary" | "secondary";
export type SystemHealthIndicatorSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SystemHealthIndicatorProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SystemHealthIndicatorVariant;
  size?: SystemHealthIndicatorSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const SystemHealthIndicator = forwardRef<HTMLDivElement, SystemHealthIndicatorProps>(function SystemHealthIndicator(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SystemHealthIndicator"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
            <span className="text-white font-semibold text-sm">SY</span>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">System Health Indicator</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/SystemHealthIndicator</span>
