...
export type SupportTicketListVariant = "default" | "primary" | "secondary" | "destructive";
export type SupportTicketListSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SupportTicketListProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SupportTicketListVariant;
  size?: SupportTicketListSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const SupportTicketList = forwardRef<HTMLDivElement, SupportTicketListProps>(function SupportTicketList(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SupportTicketList"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Support Ticket List</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/SupportTicketList</span>
