...
import type { MetricsExplorerProps } from "./MetricsExplorer";

// ─── Types ───

export type SLOTrackerVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type SLOTrackerSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SLOTrackerProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SLOTrackerVariant;
  size?: SLOTrackerSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
...
export const SLOTracker = forwardRef<HTMLDivElement, SLOTrackerProps>(function SLOTracker(
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">S L O Tracker</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/SLOTracker</span>
