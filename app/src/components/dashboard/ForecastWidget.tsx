...
import type { CPUChartProps } from "./CPUChart";
import type { DiskUsageChartProps } from "./DiskUsageChart";
import type { NetworkTrafficChartProps } from "./NetworkTrafficChart";

// ─── Types ───

export type ForecastWidgetVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type ForecastWidgetSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ForecastWidgetProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ForecastWidgetVariant;
  size?: ForecastWidgetSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const ForecastWidget = forwardRef<HTMLDivElement, ForecastWidgetProps>(function ForecastWidget(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ForecastWidget"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Forecast Widget</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/ForecastWidget</span>
