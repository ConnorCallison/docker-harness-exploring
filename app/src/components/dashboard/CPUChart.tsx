...
import type { RevenueChartProps } from "./RevenueChart";

// ─── Types ───

export type CPUChartVariant = "default" | "primary" | "secondary" | "destructive" | "outline";
export type CPUChartSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface CPUChartProps {
  className?: string;
  children?: React.ReactNode;
  variant?: CPUChartVariant;
  size?: CPUChartSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
...
export const CPUChart = forwardRef<HTMLDivElement, CPUChartProps>(function CPUChart(
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">C P U Chart</h3>
