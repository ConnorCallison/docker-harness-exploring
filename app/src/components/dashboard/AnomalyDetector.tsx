...
import type { ThroughputWidgetProps } from "./ThroughputWidget";
import type { P99LatencyWidgetProps } from "./P99LatencyWidget";
import type { SLOTrackerProps } from "./SLOTracker";

// ─── Types ───

export type AnomalyDetectorVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type AnomalyDetectorSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface AnomalyDetectorProps {
  className?: string;
  children?: React.ReactNode;
  variant?: AnomalyDetectorVariant;
  size?: AnomalyDetectorSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const AnomalyDetector = forwardRef<HTMLDivElement, AnomalyDetectorProps>(function AnomalyDetector(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "AnomalyDetector"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Anomaly Detector</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/AnomalyDetector</span>
