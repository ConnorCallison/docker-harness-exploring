...
export type ConversionFunnelVariant = "default" | "primary" | "secondary";
export type ConversionFunnelSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ConversionFunnelProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ConversionFunnelVariant;
  size?: ConversionFunnelSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const ConversionFunnel = forwardRef<HTMLDivElement, ConversionFunnelProps>(function ConversionFunnel(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ConversionFunnel"}
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/ConversionFunnel</span>
