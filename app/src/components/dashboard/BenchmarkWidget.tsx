...
export type BenchmarkWidgetVariant = "default" | "primary" | "secondary" | "destructive";
export type BenchmarkWidgetSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface BenchmarkWidgetProps {
  className?: string;
  children?: React.ReactNode;
  variant?: BenchmarkWidgetVariant;
  size?: BenchmarkWidgetSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const BenchmarkWidget = forwardRef<HTMLDivElement, BenchmarkWidgetProps>(function BenchmarkWidget(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "BenchmarkWidget"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Benchmark Widget</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/BenchmarkWidget</span>
