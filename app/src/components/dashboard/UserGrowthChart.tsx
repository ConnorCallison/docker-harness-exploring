...
import type { SpanTimelineProps } from "./SpanTimeline";
import type { ServiceMapProps } from "./ServiceMap";

// ─── Types ───

export type UserGrowthChartVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type UserGrowthChartSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface UserGrowthChartProps {
  className?: string;
  children?: React.ReactNode;
  variant?: UserGrowthChartVariant;
  size?: UserGrowthChartSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const UserGrowthChart = forwardRef<HTMLDivElement, UserGrowthChartProps>(function UserGrowthChart(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "UserGrowthChart"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">User Growth Chart</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/UserGrowthChart</span>
