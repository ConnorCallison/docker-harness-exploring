...
export type RevenueChartVariant = "default" | "primary" | "secondary";
export type RevenueChartSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface RevenueChartProps {
  className?: string;
  children?: React.ReactNode;
  variant?: RevenueChartVariant;
  size?: RevenueChartSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const RevenueChart = forwardRef<HTMLDivElement, RevenueChartProps>(function RevenueChart(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "RevenueChart"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Revenue Chart</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/RevenueChart</span>
