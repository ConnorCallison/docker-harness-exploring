...
import type { CostExplorerProps } from "./CostExplorer";
import type { CapacityPlannerProps } from "./CapacityPlanner";

// ─── Types ───

export type ResourceUsageVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type ResourceUsageSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ResourceUsageProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ResourceUsageVariant;
  size?: ResourceUsageSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const ResourceUsage = forwardRef<HTMLDivElement, ResourceUsageProps>(function ResourceUsage(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "ResourceUsage"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Resource Usage</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/ResourceUsage</span>
