...
export type DependencyGraphVariant = "default" | "primary" | "secondary" | "destructive";
export type DependencyGraphSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface DependencyGraphProps {
  className?: string;
  children?: React.ReactNode;
  variant?: DependencyGraphVariant;
  size?: DependencyGraphSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const DependencyGraph = forwardRef<HTMLDivElement, DependencyGraphProps>(function DependencyGraph(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "DependencyGraph"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Dependency Graph</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/DependencyGraph</span>
