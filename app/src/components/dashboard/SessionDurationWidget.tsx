...
import type { RecentOrdersListProps } from "./RecentOrdersList";
import type { SupportTicketListProps } from "./SupportTicketList";
import type { SystemHealthIndicatorProps } from "./SystemHealthIndicator";

// ─── Types ───

export type SessionDurationWidgetVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type SessionDurationWidgetSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface SessionDurationWidgetProps {
  className?: string;
  children?: React.ReactNode;
  variant?: SessionDurationWidgetVariant;
  size?: SessionDurationWidgetSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const SessionDurationWidget = forwardRef<HTMLDivElement, SessionDurationWidgetProps>(function SessionDurationWidget(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "SessionDurationWidget"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Session Duration Widget</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/SessionDurationWidget</span>
