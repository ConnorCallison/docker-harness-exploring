...
import type { ForecastWidgetProps } from "./ForecastWidget";
import type { AnomalyDetectorProps } from "./AnomalyDetector";
import type { CorrelationViewProps } from "./CorrelationView";

// ─── Types ───

export type TraceViewerVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost" | "link";
export type TraceViewerSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface TraceViewerProps {
  className?: string;
  children?: React.ReactNode;
  variant?: TraceViewerVariant;
  size?: TraceViewerSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const TraceViewer = forwardRef<HTMLDivElement, TraceViewerProps>(function TraceViewer(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "TraceViewer"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Trace Viewer</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/TraceViewer</span>
