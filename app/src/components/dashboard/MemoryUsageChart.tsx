...
export type MemoryUsageChartVariant = "default" | "primary" | "secondary";
export type MemoryUsageChartSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface MemoryUsageChartProps {
  className?: string;
  children?: React.ReactNode;
  variant?: MemoryUsageChartVariant;
  size?: MemoryUsageChartSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
  testId?: string;
...
export const MemoryUsageChart = forwardRef<HTMLDivElement, MemoryUsageChartProps>(function MemoryUsageChart(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "MemoryUsageChart"}
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Memory Usage Chart</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/MemoryUsageChart</span>
