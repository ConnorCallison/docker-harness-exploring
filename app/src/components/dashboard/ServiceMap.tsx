...
export type ServiceMapVariant = "default" | "primary" | "secondary" | "destructive" | "outline" | "ghost";
export type ServiceMapSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface ServiceMapProps {
  className?: string;
  children?: React.ReactNode;
  variant?: ServiceMapVariant;
  size?: ServiceMapSize;
  disabled?: boolean;
  loading?: boolean;
  id?: string;
...
export const ServiceMap = forwardRef<HTMLDivElement, ServiceMapProps>(function ServiceMap(
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Service Map</h3>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-500">
        <span>dashboard/ServiceMap</span>
