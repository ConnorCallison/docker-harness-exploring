...
export type BackgroundImageVariant = "default" | "primary" | "secondary";
export type BackgroundImageSize = "xs" | "sm" | "md" | "lg" | "xl";
...
export const BackgroundImage = forwardRef<HTMLDivElement, BackgroundImageProps>(function BackgroundImage(
  ...
  return (
    <div
      ref={ref}
      id={id}
      data-testid={testId ?? "BackgroundImage"}
