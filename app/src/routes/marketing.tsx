...
const MarketingFilterSchema = z.object({
...
export async function loader({ request, params }: Route.LoaderArgs) {
  ...
  const filters = MarketingFilterSchema.parse(Object.fromEntries(url.searchParams));

  // Simulated data generation
  const total = 100;
  const items: MarketingItem[] = Array.from({ length: filters.perPage }, (_, i) => {
...
export function meta() {
  return [
    { title: "Marketing | Docker Harness App" },
    { name: "description", content: "Manage marketing" },
  ];
}
