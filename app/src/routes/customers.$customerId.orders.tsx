import type { Route } from "./+types/customers.$customerId.orders";
...
const CustomerOrdersFilterSchema = z.object({
...
export async function loader({ request, params }: Route.LoaderArgs) {
  ...
  const filters = CustomerOrdersFilterSchema.parse(Object.fromEntries(url.searchParams));

  // Simulated data generation
  const total = 117;
  const items: CustomerOrdersItem[] = Array.from({ length: filters.perPage }, (_, i) => {
...
export function meta() {
  return [
    { title: "Customer Orders | Docker Harness App" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Customer Orders</h2>
