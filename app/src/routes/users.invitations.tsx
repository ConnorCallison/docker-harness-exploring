import type { Route } from "./+types/users.invitations";
...
interface UsersInvitationsItem {
  id: string;
  name: string;
...
export function meta() {
  return [
    { title: "Users Invitations | Docker Harness App" },
    { name: "description", content: "Manage users invitations" },
  ];
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Users Invitations</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage and track users invitations</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8 text-center">
        <p className="text-gray-500 dark:text-gray-400">Content for Users Invitations</p>
      </div>
    </div>
  );
}
