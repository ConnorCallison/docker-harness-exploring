...
interface SettingsNotificationsItem {
  id: string;
  name: string;
...
export function meta() {
  return [
    { title: "Settings Notifications | Docker Harness App" },
    { name: "description", content: "Manage settings notifications" },
  ];
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Settings Notifications</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage and track settings notifications</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8 text-center">
        <p className="text-gray-500 dark:text-gray-400">Content for Settings Notifications</p>
      </div>
    </div>
  );
}
