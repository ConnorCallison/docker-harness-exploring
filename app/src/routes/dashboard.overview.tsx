...
export function meta() {
  return [
    { title: "Dashboard Overview | Docker Harness App" },
    { name: "description", content: "Manage dashboard overview" },
  ];
}
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage and track dashboard overview</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8 text-center">
        <p className="text-gray-500 dark:text-gray-400">Content for Dashboard Overview</p>
      </div>
    </div>
  );
}
