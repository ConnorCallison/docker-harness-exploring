import type { Route } from "./+types/marketing.campaigns";
...
interface MarketingCampaignsItem {
  id: string;
  name: string;
...
export function meta() {
  return [
    { title: "Marketing Campaigns | Docker Harness App" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Marketing Campaigns</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage and track marketing campaigns</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8 text-center">
        <p className="text-gray-500 dark:text-gray-400">Content for Marketing Campaigns</p>
      </div>
    </div>
  );
}
